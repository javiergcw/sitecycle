...
class _PhoneVerificationState extends State<PhoneVerification> {
    ...
    return Scaffold(
      backgroundColor: notifire.getBgColor,
       body: LayoutBuilder(
         ...
         return constraints.maxWidth < 900 ? phoneverify1(constraints) :  constraints.maxWidth < 1450 ? phoneverify2(constraints) : phoneverify3(constraints);
       },),
    );
  }

  Widget phoneverify3(constraints){
    return Padding(
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Phone Verification'.tr,style: TextStyle(fontSize: 30, color: notifire.getContainer, fontFamily: FontFamily.qBold), overflow: TextOverflow.ellipsis,),
                  ...
                  Text('Enter Otp'.tr, style: TextStyle(fontSize: 16, color: notifire.getContainer, fontFamily: FontFamily.qBold)),
  ...
  Widget phoneverify2(constraints){
    return  Padding(
      padding: const EdgeInsets.all(20),
      child: Container(
        decoration: BoxDecoration(
        ...
        child: Row(
          children: [
            constraints.maxWidth < 1450 ? SizedBox(width: constraints.maxWidth < 990 ? 50 : 100,) : const Spacer(),
            Expanded(
              flex: constraints.maxWidth < 1450 ? 3 : 2,
              child: Padding(
                padding: EdgeInsets.only(left: constraints.maxWidth < 1450 ? 20 : 0),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const SizedBox(height: 30),
                    Text('Phone Verification'.tr,style: TextStyle(fontSize: 20, color: notifire.getContainer, fontFamily: FontFamily.qBold), overflow: TextOverflow.ellipsis,),
                    const SizedBox(height: 10),

                    Text('Mobile Number'.tr, style: TextStyle(fontSize: 13, color: notifire.getContainer, fontFamily: FontFamily.qBold)),
                    Container(
                      height: 45,
                      margin: const EdgeInsets.symmetric(vertical: 13),
                      child: TextField(
                        keyboardType: TextInputType.phone,
                        style: TextStyle(fontSize: 13, color: notifire.getContainer, fontFamily: FontFamily.qRegular,fontWeight: FontWeight.w700),
                        decoration: InputDecoration(
                            hintText: 'Mobile Number'.tr,
                            prefixIcon: Padding(
                              padding: const EdgeInsets.all(8.0),
                            ...
                            hintStyle:  const TextStyle(color: Colors.grey,fontSize: 13,fontFamily: FontFamily.qRegular),
                            contentPadding: const EdgeInsets.only(left: 20, right: 20),
                            filled: true,
                            fillColor: notifire.getContentColor,
                            focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: blue),borderRadius: const BorderRadius.all(Radius.circular(12))),
                    ...
                    Text('Enter Otp'.tr, style: TextStyle(fontSize: 13, color: notifire.getContainer, fontFamily: FontFamily.qBold)),
                    const SizedBox(height: 13 ),
                    OtpTextField(
                      fieldHeight: 45,
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child:  Center(child: Text('Procced'.tr,style: TextStyle(fontSize: 12, color: notifire.text,fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700))),
                            ),
                          ),
                        ),
                      ],
  ...
  Widget phoneverify1(constraints){
    return  Padding(
      padding: const EdgeInsets.all(20),
      child: Container(
        decoration: BoxDecoration(
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 30),
                  Text('Phone Verification'.tr,style: TextStyle(fontSize: 22, color: notifire.getContainer, fontFamily: FontFamily.qBold), overflow: TextOverflow.ellipsis,),
                  const SizedBox(height: 20),
