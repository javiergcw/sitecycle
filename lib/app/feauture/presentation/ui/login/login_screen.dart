...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    try {
      ...
      Get.offAll(const DrawerMain()); // Navegar a la pantalla principal
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          return constraints.maxWidth < 870 ? login2(constraints) : constraints.maxWidth < 1328 ? login1(constraints) : login(constraints);
        },
      ),
    );
  }
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('Login to your account'.tr, style: TextStyle(fontSize: 32, color: notifire.getContainer, fontFamily: FontFamily.qBold), overflow: TextOverflow.ellipsis,),
                  const SizedBox(height: 10),
                  Text('Your Email'.tr, style: TextStyle(fontSize: 18, color: notifire.getContainer, fontFamily: FontFamily.qBold)),
                  ...
                  Text('Password'.tr, style: TextStyle(fontSize: 18, color: notifire.getContainer, fontFamily: FontFamily.qBold)),
                    ...
                    child: Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Text('Forgot password?'.tr, style: TextStyle(fontSize: 13, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w600))),
                      ],
                    ),
                  ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('Login'.tr, style: TextStyle(fontSize: 15, color: notifire.text, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700))),
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text("not registered yet?".tr, style: const TextStyle(color: Colors.grey, fontSize: 18, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,),
                      InkWell(onTap: () {
                        Get.to(const SignupScreen());
                      }, child: Text(" Try Sign Up".tr, style: TextStyle(color: notifire.getContainer, fontSize: 18, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,)),
                    ],
                  ),
                  RichText(
                    text: const TextSpan(
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 30),
                  Text('Login to your account'.tr, style: TextStyle(fontSize: 19, color: notifire.getContainer, fontFamily: FontFamily.qBold), overflow: TextOverflow.ellipsis,),
                  const SizedBox(height: 10),
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Keep me signed in'.tr, style: TextStyle(fontSize: 9, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w600)),
                        const Spacer(),
                        InkWell(
                          onTap: () {
                            Get.to(const PhoneVerification());
                          },
                          child: Text('Forgot password?'.tr, style: TextStyle(fontSize: 9, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w600))),
                      ],
                    ),
                  ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('Login'.tr, style: TextStyle(fontSize: 11, color: notifire.getBgColor, fontWeight: FontWeight.w700, fontFamily: FontFamily.qBold))),
                    ),
                  ),

                  const SizedBox(height: 70),
                  Text('or continue with open account'.tr, style: TextStyle(fontSize: 11, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,),
                  ...
                  InkWell(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          const TextSpan(text: 'not registered yet? ', style: TextStyle(color: Colors.grey, fontSize: 11, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700)),
                          TextSpan(text: 'Try Sign Up', style: TextStyle(color: notifire.getContainer, fontSize: 11, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700),),
                        ],
                      )),
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      const Text('Copyright Miracle 2024', style: TextStyle(fontSize: 7, color: Color(0xff99B2C6), fontFamily: FontFamily.qRegular, fontWeight: FontWeight.w700)),
                    ],
                  ),
                ],
              ),
              ...
              children: [
                ...
                SizedBox(
                  child: Row(
                    children: [
                      ...
                      Text('Keep me signed in'.tr, style: TextStyle(fontSize: 12, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w600)),
                      const Spacer(),
                      InkWell(
                          onTap: () {
                            Get.to(const PhoneVerification());
                          },
                          child: Text('Forgot password?'.tr, style: TextStyle(fontSize: 12, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w600))),
                    ],
                  ),
                ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('Login'.tr, style: TextStyle(fontSize: 15, color: notifire.getBgColor, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700))),
                  ),
                ),

                const SizedBox(height: 30),
                Text('or continue with open account'.tr, style: TextStyle(fontSize: 12, color: notifire.getContainer, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,),
                ...
                Row(
                  children: [
                    Text("not registered yet?".tr, style: const TextStyle(color: Colors.grey, fontSize: 12, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,),
                    InkWell(onTap: () {
                      Get.to(const SignupScreen());
                    }, child: Text(" Try Sign Up".tr, style: TextStyle(color: notifire.getContainer, fontSize: 12, fontFamily: FontFamily.qBold, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis,))
                  ],
                ),
                ...
                Row(
                  children: [
                    Image.asset(Appcontent.copyright, height: 10),
                    const SizedBox(width: 10),
                    const Text('Copyright Miracle 2024', style: TextStyle(fontSize: 10, color: Color(0xff99B2C6), fontFamily: FontFamily.qRegular, fontWeight: FontWeight.w700)),
                  ],
                ),
              ],
            ),
